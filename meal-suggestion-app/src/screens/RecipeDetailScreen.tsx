...
const styles = StyleSheet.create({
  ...
  author: { fontSize: 13, color: colors.textSecondary, marginTop: 4, marginBottom: spacing.md, lineHeight: 18 },
  metaRow: { flexDirection: 'row', gap: spacing.lg, marginBottom: spacing.md },
  metaItem: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  metaText: { fontSize: 13, color: colors.textSecondary, lineHeight: 18 },
  ...
  tagPillText: { fontSize: 12, color: colors.textPrimary, fontWeight: '500' },
  matchPill: {
  ...
  matchPillText: { fontSize: 12, color: colors.accent, fontWeight: '700' },
